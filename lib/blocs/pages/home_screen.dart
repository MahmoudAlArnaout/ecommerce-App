...
import '../them_bloc/theme_bloc.dart';
import '../them_bloc/theme_event.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => HomeBloc()..add(LoadItems()),
        ),
        BlocProvider(
                  ...
                  tabs: [
                    ...
                    Tab(
                        ...
                        child: InkWell(
                          ...
                          child: const Text("Text Recognition",textAlign: TextAlign.center,),
                        )),
                    Tab(
                      ...
                      children: [
                        Expanded(
                          child: ListTile(
                            title: Text(
                              "user@example.com",
                              // Use user info from your UserBloc
